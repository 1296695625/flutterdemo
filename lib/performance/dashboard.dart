...
class DashBoard extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return new DashBoardState(width,height,text);
  }
  DashBoard({this.width,this.height,this.text});
}
...
class DashBoardState extends State<DashBoard>{
  ...
  double w,h;
  String t;
  DashBoardState(this.w,this.h,this.t);
  @override
  void initState() {
    super.initState();
    dashBoardSize=new Size(null==w?300.0:w,null==h?300.0:h);
...
//            handleEndEvent();
          ...
          child:new CustomPaint(
            size: dashBoardSize,
            painter: new DashBoardIndicatorPainter(100,tableSpace,_pictureBackGround,_pictureIndicator),
          ),
        ),
      );
//    );
...
class DashBoardIndicatorPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    drawSpeendOnDashBoard(speeds.toString()+"%",canvas, size);
  }
